  ...
  const handleOAuthSignup = async (
    ...
    try {
      const { error } = await supabase.auth.signInWithOAuth({
        provider: provider === "apple" ? "github" : provider, // Apple не поддерживается напрямую в Supabase
        options: {
      ...
      <div className="relative z-10 w-full flex">
        ...
        <div className="w-full lg:flex-1 lg:max-w-xl xl:max-w-2xl flex items-center justify-center px-6 py-12 lg:px-8">
          <div className="w-full max-w-2xl space-y-8">
            ...
            {/* Form Card */}
            <div className="bg-white lg:rounded-xl lg:shadow-xl py-6 lg:py-20 lg:px-28 sm:px-24">
              {/* Header */}
              ...
              <div className="flex justify-around items-center gap-6">
                ...
                <Button
                  ...
                  disabled={isLoading}
                  className="w-full h-12 bg-white hover:bg-gray-50 text-gray-700 border-gray-300 mt-0"
                >
